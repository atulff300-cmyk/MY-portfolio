  ...
  return (
    <section id="contact" className="px-6 md:px-20 bg-transparent flex flex-col items-center">
      <div className="max-w-3xl w-full mx-auto relative z-10 text-center bg-[#0a0a0a]/70 backdrop-blur-md p-6 md:p-16 rounded-2xl border border-zinc-800/50 shadow-sm">
        <h2 className="text-3xl md:text-5xl font-black mb-6 text-zinc-100 tracking-tight uppercase drop-shadow-md">Get In Touch</h2>
        <p className="text-zinc-400 font-light mb-12 text-lg md:text-xl">
          Interested in working together, have a project in mind, or just want to say hi? Let's talk!
        </p>
        
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
            {/* WhatsApp Button */}
            <a 
              href="https://wa.me/916006522814" 
              target="_blank" 
              rel="noreferrer"
              className="w-full sm:w-auto btn-3d px-6 py-3 bg-[#25D366] text-white font-bold rounded-xl flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(37,211,102,0.4)] hover:bg-[#128C7E] transition-colors tracking-wide uppercase text-sm"
            >
            ...
            {/* LinkedIn Button */}
            <a 
              href="https://linkedin.com/in/atul" 
              target="_blank" 
              rel="noreferrer"
              className="w-full sm:w-auto btn-3d px-6 py-3 bg-[#0A66C2] text-white font-bold rounded-xl flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(10,102,194,0.4)] hover:bg-[#084e96] transition-colors tracking-wide uppercase text-sm"
            >
            ...
            {/* GitHub Button */}
            <a 
              href="https://github.com/atul" 
              target="_blank" 
              rel="noreferrer"
              className="w-full sm:w-auto btn-3d px-6 py-3 bg-[#333] text-white font-bold rounded-xl flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(51,51,51,0.4)] hover:bg-[#111] transition-colors tracking-wide uppercase text-sm"
            >
            ...
            {/* Download Resume */}
            <a 
              href="/Atul_s_Kumar_Resume_06_06_2026.pdf" download="A kumar resume.pdf"
